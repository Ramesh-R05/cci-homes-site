export default {
    ...
    data: [
        ...
        {
            id: 'HOMES-3178',
            url: '/joe-test-homes-article-test-3178',
            path: ['HOMES--1', 'HOMES-1158', 'HOMES-1237', 'HOMES-2791', 'HOMES-3077', 'HOMES-3178'],
            tags: ['food:Topic:Bathroom news', 'food:Homes navigation:Outdoor'],
            source: 'Belle',
            sortOrder: '82',
            contentYear: 2016,
            tagsDetails: [
            ...
            contentMonth: 8,
            contentTitle: 'Joe Test Homes Article',
            contentVideo: '',
            nodeTypeAlias: 'HomesArticle',
            contentHasVideo: false,
        ...
        {
            id: 'HOMES-3157',
            url: '/joetest-home-article-new-3157',
            path: ['HOMES--1', 'HOMES-1158', 'HOMES-1237', 'HOMES-2791', 'HOMES-3077', 'HOMES-3157'],
            tags: ['food:Topic:In focus', 'food:Homes navigation:DIY'],
            source: 'Belle',
            sortOrder: '61',
            contentYear: 2016,
            tagsDetails: [
            ...
            contentMonth: 8,
            contentTitle: 'joetest home article new',
            contentVideo: '',
            nodeTypeAlias: 'HomesArticle',
        ...
        {
            id: 'HOMES-3082',
            url: '/joe-test-gallery-test-3082',
            path: ['HOMES--1', 'HOMES-1158', 'HOMES-1579', 'HOMES-2783', 'HOMES-3083', 'HOMES-3082'],
            tags: [],
            source: 'Belle',
            sortOrder: '1',
            contentTags: [],
        ...
        {
            id: 'HOMES-3081',
            url: '/joe-test-new-article-2016-test1-3081',
            path: ['HOMES--1', 'HOMES-1158', 'HOMES-1237', 'HOMES-2791', 'HOMES-3077', 'HOMES-3081'],
            tags: ['food:Topic:Inspired by', 'food:Homes navigation:My Ideal House'],
            source: 'Belle',
            sortOrder: '1',
            contentYear: 2016,
            tagsDetails: [
            ...
            contentMonth: 8,
            contentTitle: 'joe test new article 2016',
            contentVideo: '',
            nodeTypeAlias: 'HomesArticle',
        ...
        {
            id: 'HOMES-3078',
            url: '/joetest-dsp-88-3078',
            path: ['HOMES--1', 'HOMES-1158', 'HOMES-1237', 'HOMES-2791', 'HOMES-3079', 'HOMES-3078'],
            tags: ['food:Topic:How to', 'food:Homes navigation:DIY'],
            source: 'Belle',
            sortOrder: '1',
            contentYear: 2016,
            tagsDetails: [
            ...
            contentMonth: 7,
            contentTitle: 'joetest dsp 3 long title',
            contentVideo: '',
            nodeTypeAlias: 'HomesArticle',
        ...
        },
        {
            ...
            path: ['HOMES--1', 'HOMES-1158', 'HOMES-1237', 'HOMES-2791', 'HOMES-3202', 'HOMES-3073'],
            tags: ['food:Topic:Profile', 'food:Homes navigation:DIY'],
            source: 'Belle',
            sortOrder: '1',
            contentYear: 2016,
            tagsDetails: [
        ...
        {
            id: 'HOMES-3067',
            url: '/theo-likes-tags-3067',
            path: ['HOMES--1', 'HOMES-1158', 'HOMES-1237', 'HOMES-2791', 'HOMES-3068', 'HOMES-3067'],
            tags: ['food:Decorating:Colour:Pattern:Floral', 'food:Topic:In focus', 'food:Topic:Tips and advice', 'food:Homes navigation:DIY'],
            source: 'Belle',
            sortOrder: '1',
            contentYear: 2016,
            tagsDetails: [
                ...
                {
                    name: 'food:Decorating:Colour:Pattern:Floral',
                    urlName: 'floral',
                    fullName: 'food_Decorating_Colour_Pattern_Floral',
                    displayName: 'Floral'
                }
            ],
            contentMonth: 4,
            contentTitle: 'Theo loves tags REALLY',
            contentVideo: '',
            nodeTypeAlias: 'HomesArticle',
            ...
            nodeTypeAliasPath: ['Page', 'Editorial', 'Articles', 'HomesArticle'],
            contentImageAltText: 'Theo'
        },
        {
            id: 'HOMES-3019',
            url: '/all-white-sophisticated-kitchens-and-bathrooms-3019',
            path: ['HOMES--1', 'HOMES-1158', 'HOMES-1237', 'HOMES-2791', 'HOMES-2890', 'HOMES-3019'],
            tags: [
            ...
            tagsDetails: [
                {
                    name: 'food:Topic:Hot trend',
                    urlName: 'hot-trend',
                    fullName: 'food_Topic_Hot_trend',
                    displayName: 'Hot trend'
                },
                {
                    name: 'food:Renovating:Materials:Marble',
                    urlName: 'marble',
                    fullName: 'food_Renovating_Materials_Marble',
                    displayName: 'Marble'
                },
                {
            ...
            contentMonth: 2,
            contentTitle: 'All white: Sophisticated kitchens & bathrooms',
            contentVideo: '',
            nodeTypeAlias: 'HomesArticle',
            ...
            nodeTypeAliasPath: ['Page', 'Editorial', 'Articles', 'HomesArticle'],
            contentImageAltText: 'luxury white kitchen',
            contentImageCaption:
                'Drifts of marble with perfectly matched veins set the scene in this heavenly kitchen by [David Hicks](http://www.davidhicks.com/?utm_campaign=supplier/|target="_blank"). Photo: Shannon McGrath'
        },
        {
            id: 'HOMES-3009',
        ...
        },
        {
            ...
            tags: [
                'food:Room:Other rooms:Bar room',
                "food:Topic:Buyer's guide",
                'food:Occasion:Dinner party',
                'food:Equipment:Dinnerware',
                'food:Occasion:Cocktail party',
                'food:Decorating:Style:Luxe',
            ...
            nodeTypeAlias: 'Gallery',
            contentSummary:
                'Pop a champagne cork, shake a martini, mix a gin and tonic – it will all seem so much more glamorous served from one of these bar trolleys.',
            pageSearchTags: [
                'Bar room',
                'Bar-room',
                'bar-room',
