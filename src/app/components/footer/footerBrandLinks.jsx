...
export default class FooterBrandLinks extends Component {
    ...
    insertNewLineForFooterLogo = () => {
        if (canUseDOM) {
            ...
            if (typeof document.getElementsByClassName("footer__logos-list")[0] !== 'undefined') {
                let listElements = document.getElementsByClassName("footer__logos-list")[0].getElementsByTagName("li");
                let secondListElement = listElements[1];
    ...
    render() {
        ...
        const footerLogos = footerBrands.map(
            (item, i) => {
